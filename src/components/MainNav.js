            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light yelp-red-bg">
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                    ...
                    <form class="form-inline my-2 my-lg-0 ">
                        <input class="form-control mr-sm-2 input-field" type="search" placeholder="Find: Tacos, cheap dinner, Max's" />
                        <input class="form-control mr-sm-2 input-field" type="search" placeholder="Near: San Francisco, CA" />
                        <span>
