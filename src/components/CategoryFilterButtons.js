        ...
        <div className="category-filter">
            <div className="container">                
                ...
                <div className="filters">
                    <button className="btn btnFilter mrg-5">
                    ...
                    <div class="btn-group btn-group-justified mrg-5">
                        <a href="#" class="btn btnFilter">$</a>
                        <a href="#" class="btn btnFilter">$$</a>
                        <a href="#" class="btn btnFilter">$$$</a>
                        <a href="#" class="btn btnFilter">$$$$</a>
                    </div>
                ...
                <div>
                    <div class="form-group filter-select">
                        ...
                        <span className="col-sm-2">
                            <button className="btn btn-success">Find Table</button>
                        </span>
